              ...
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex items-start">
                  <div class="flex-shrink-0">
                      ...
                      <div class="ml-3">
                        <h3 class="text-sm font-bold text-blue-800">Edición cuenta de usuario</h3>
                        <div class="mt-1 text-sm text-blue-600">
                          <p>La <strong>información de acceso </strong> (Nombre,Email y contraseña) debe gestionarse desde la cuenta de usuario asociada.
                    </p>
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="flex items-start">
                    <x-wire-button primary sm href="{{ route('admin.users.edit', $patient->user)}}" target="_blank">
                      Eitar usuario <i class="fa-solid fa-arrow-up-right-from-square ms-2"></i>
                    </x-wire-button>
                  </div>
